...
import 'package:loapetition/pages/contents/contentssurveypage.dart';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          final highestLevel = _characters.isNotEmpty
              ? double.tryParse(_characters[0]['ItemMaxLevel'].replaceAll(',', '')) ?? 0
              : 0;

          _raids.clear();

          raidlevel.forEach((key, value) {
                        ...
                        return ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            ...
                            shape: RoundedRectangleBorder(
                              borderRadius:
                                  BorderRadius.circular(15), // Match the container's border radius
                            ),
                          ),
                          onPressed: () {
